...
For the character variables I broke them out by category and created an indes by performing this calculation.  (Churn Rate Per Category)/(Overall Churn Rate) * 100
